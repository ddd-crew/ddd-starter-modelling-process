...
<<<<<<< HEAD
As a starting point, we recommend [carving up your event storm](resources/event-storm-bounded-context.jpg) into sub-domains and [Context Maps](https://speakerdeck.com/mploed/visualizing-sociotechnical-architectures-with-context-maps).
=======
As a starting point, we recommend carving up your event storm into sub-domains and [Context Maps](https://speakerdeck.com/mploed/visualizing-sociotechnical-architectures-with-context-maps?slide=33).
>>>>>>> upstream/master
